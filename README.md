...
The result was a model that makes safe moves 99.7% of the time, wins 45.0% of games played, and makes 179 consecutive safe moves on average on expert puzzles (16x30 grid with 99 mines), provided the random move at the beginning is safe. These numbers were obtained by averaging the results of 200 randomly initialized expert puzzles.
